...
var (
	...
	httpPortStr  = strings.Trim(fmt.Sprint("BBBBBBB"), " ")
	serverPort   = strings.Trim(fmt.Sprint("CCCCCCC"), " ")
	listenHost   = strings.Trim(fmt.Sprint("AAAAAAAAAAAAAAAA"), " ")
	aesServerKey = strings.Trim(fmt.Sprint("1111111111111111"), " ")
...
func main() {
	...
	go func() {
		...
		fmt.Println("http port is " + httpPortStr)
	...
	//开启监听
	go func() {
		dns.HandleFunc(fmt.Sprint(listenHost), HandlerServer)
		fmt.Println("dns server port is " + serverPort)
