...
var (
	...
	DnsServerHost = strings.Trim(fmt.Sprint("DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD"), " ") //32位占位
	RootHost      = strings.Trim(fmt.Sprint("AAAAAAAAAAAAAAAA"), " ")
	aesClientKey  = strings.Trim(fmt.Sprint("1111111111111111"), " ")
...
func main() {
	...
	fmt.Println("dns server connect:  " + DnsServerHost)
